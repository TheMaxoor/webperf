...
const model = [
    {
        ...
        route: 'fesh',
        pros: ['Salty', 'Shiny'],
        cons: ['Tough to hold', 'Sometimes runs away']
    },
    {
        name: 'Brrto',
        ...
        body: 'Portable noms',
        route: 'brrto',
        pros: ['Many flavor', 'Travels well'],
        cons: ['Often wrapped in scary shiny metal', 'Heavy']
    },
    {
        name: 'Pezza',
        ...
        body: 'Gooey hotness',
        route: 'pezza',
        pros: ['Maximum chees', 'Still good after many days'],
        cons: ['Too much hot', 'Hard to lick']
    },
    {
        name: 'Soop',
        ...
        body: 'Cozy warm',
        route: 'soop',
        pros: ['Smooth on tongue', 'Pretty'],
        cons: ['Cannot put in pockets', 'Makes your face messy']
    }
];
